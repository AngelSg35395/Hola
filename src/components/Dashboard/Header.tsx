        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="mb-8 md:mb-0 md:mr-8 text-center md:text-left">
            ...
            <p className="text-xl text-gray-100 max-w-2xl">
              Welcome to our community waste management dashboard, where data drives 
              environmental progress through collective action and transparent tracking.
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg shadow-lg inline-flex items-center justify-center">
            ...
            <div>
              <p className="text-sm font-medium text-gray-100">Current Month</p>
              <p className="text-2xl font-bold">897 kg</p>
              <p className="text-sm text-accent-300">↑ 12.3% from last month</p>
            </div>
          </div>
        </div>
      </div>
